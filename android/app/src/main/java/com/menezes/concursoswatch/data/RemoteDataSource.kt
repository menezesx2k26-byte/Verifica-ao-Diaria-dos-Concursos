...
class RemoteDataSource {
        ...
        val items = buildList {
            for (i in 0 until itemsJson.length()) {
                ...
                add(Contest(
                    ...
                    organization = o.optString("organization", o.optString("source")), city = o.optString("city"),
                    uf = o.optString("uf"), region = o.optString("region"), scope = o.optString("scope"), type = o.optString("type"),
                    education = o.optString("education"), area = o.optString("area"), remuneration = o.optString("remuneration"),
                    vacancies = o.optString("vacancies"), fee = o.optString("fee"), startDate = o.optString("start_date"),
                    endDate = o.optString("end_date"), status = o.optString("status", "detected"), source = o.optString("source"),
                    url = o.optString("url"), editalUrl = o.optString("edital_url", o.optString("url")), firstSeen = o.optString("first_seen"),
                    lastSeen = o.optString("last_seen"), priority = o.optInt("priority", 50), active = o.optBoolean("active", true),
                ))
            }
        }
    ...
    private fun fetchWithFallback(apiPath: String, fallback: String): String {
        if (apiBase.isNotBlank()) runCatching { return get("$apiBase$apiPath") }
        return get(fallback)
    }
